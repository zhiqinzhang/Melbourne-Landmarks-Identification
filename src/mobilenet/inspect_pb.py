...
import sys
import os
import src.mobilenet.settings as st


def inspect(model_pb=os.path.join(st.OUTPUT_ROOT,'mobilenet_v1_100_224_output_graph.pb'),
            output_txt_file=os.path.join(st.OUTPUT_ROOT,'inspect_result.txt')):
